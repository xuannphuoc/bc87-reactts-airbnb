...
import Place from "../Local/place.tsx";
...
export default function Discover() {
  ...
  px-5  "
      ...
      <h1 className="text-black/90 text-xl md:text-2xl lg:text-3xl font-bold mb-5 mt-10">
        Ở bất cứ đâu
      </h1>
      <div className="flex items-center justify-center">
        <div
          className="grid grid-cols-2 transition-all lg:grid-cols-3 xl:grid-cols-4 gap-4"
          data-wow-delay="0.4s"
        >
          <div className="animate__backInLeft animate__animated wow">
            <div className="mb-2">
              <img
                src="./images/B1.jpg"
                alt=""
          ...
          <div
            className=" animate__backInLeft animate__animated wow "
            data-wow-delay="0.6s"
          >
            <div className="mb-2">
              <img
          ...
          <div
            className="wow animate__backInLeft animate__animated "
            data-wow-delay="0.8s"
          >
            <div className="mb-2">
              <img
